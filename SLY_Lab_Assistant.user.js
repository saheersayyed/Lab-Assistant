...
*/				
	...
	const resourceTokens = [ //Token Addresses for all the resources
	// Raw Materials
        ...
        // Component
        {name: 'Energy Substrate', token: 'SUBSVX9LYiPrzHeg2bZrqFSDSKkrQkiCesr6SjtdHaX'},
	...
	{name: 'Electromagnet', token: 'EMAGoQSP89CJV5focVjrpEuE4CeqJ4k1DouQW7gUu7yX'},
        {name: 'Strange Emitter', token: 'EMiTWSLgjDVkBbLFaMcGU6QqFWzX9JX6kqs1UtUjsmJA'},
         // Compound Material
        ...
        {name: 'Hydrocarbon', token: 'HYCBuSWCJ5ZEyANexU94y1BaBPtAX2kzBgGD2vES2t6M'},
        ...
        {name: 'Steel', token: 'STEELXLJ8nfJy3P4aNuGxyNRbWPohqHSwxY75NsJRGG'},
	];
	const r4Tokens = [
		// Consumables
